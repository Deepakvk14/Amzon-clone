    ...
    return (
        ...
        <div className="container">
            ...
            <form>
               ...
               <br/> <button className="btn2" type="submit" onClick={signin}> Sign In</button>
            </form>
            <p> By Signing In you agree to Amazon Fake clone conditions 
            of use & sale. Please se our privacy Notice, Cookies Notice 
            and our intrest-based ads Notice.</p>
            <Link to="/register">
             <button className="btn2" > Create your Amazon Account</button> 
            </Link>
        </div>
                    </div>
    )
